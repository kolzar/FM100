...
namespace FM100.Views
{
    ...
    /// </summary>
    public partial class ClubSelectionView : UserControl
    {
        ...
        public ClubSelectionView(IClubRepository clubRepository)
        {
            InitializeComponent();
        ...
        {
            // Navigate back to menu - parent window will handle this
            GameStarted?.Invoke(this, (null!, -1)); // Signal to go back
        }
